        ...
        <div className="h-full">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <div>
                    ...
                    <p className="text-sm text-base-content/70">Resumen general de tu actividad</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <ul className="menu p-2">
                        ...
                        <li>
                            <a className="hover:bg-base-200">
                                ...
                                <span className="ml-auto text-xs text-base-content/70">ayer</span>
                            </a>
                        </li>
                        <li>
                            <a className="hover:bg-base-200">
                ...
                <div className="bg-base-100 rounded-lg border border-base-200">
                    ...
                    <div className="p-4 space-y-3">
                        ...
                        <div className="alert">
                            <span>Configura tus notificaciones para no perderte novedades.</span>
                        </div>
                    </div>
                </div>
            </div>
